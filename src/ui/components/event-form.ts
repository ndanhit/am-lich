...
export function renderEventForm(
  ...
  overlay.querySelector("#event-form")!.addEventListener("submit", (e) => {
    ...
    const day = parseInt(
      (overlay.querySelector("#lunar-day") as HTMLInputElement).value,
    );
    const month = parseInt(
      (overlay.querySelector("#lunar-month") as HTMLInputElement).value,
    );
    const year = parseInt(
      (overlay.querySelector("#lunar-year") as HTMLInputElement).value,
    );
...
function clearErrors(overlay: HTMLElement): void {
  ...
  overlay
    .querySelectorAll(".form-error")
    .forEach((e) => ((e as HTMLElement).textContent = ""));
}
